function marinaraSauce(cookName, two = true, oneFourth = true){
    var two = (2)
    var oneFourth = ("1/4")
    console.log(`Hey, ${cookName}! This is my marinara sauce recipe!`)
    console.log("-Heat a medium-large saucepan over medium heat")
    console.log (`-Add ${two} tspns of oil and 5 garlic cloves, cook utnil golden, about ${two} minutes`)
